...
List<Reimbursement> reimbursements = reimbursementDAO.getReimbursementById(Integer.toString(userId));
...
<a href="index.jsp">Logout</a>
	...
	<div class="container">
		...
		<table class="table table-dark" border="2" cellspacing="10"
			cellpadding="10">
			<th>User Id</th>
			<th>Amount</th>
			<th>Purpose</th>
